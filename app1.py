                ...
                if old_page and new_page:
                    ...
                    if old_code and new_code:
                        ...
                        if "impact_text" not in st.session_state:
                            st.session_state.impact_text = safe_generate(f"Analyze this code diff and explain the impact with mid sized content:\n\n{safe_diff}")
                        if "rec_text" not in st.session_state:
                            st.session_state.rec_text = safe_generate(f"As a senior engineer, suggest improvements for this diff with mid sized contens:\n\n{safe_diff}")
